...
Hooks.once("init", async function() {
  ...
  Actors.registerSheet("holdvilag", SimpleActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("holdvilag", SimpleItemSheet, { makeDefault: true });

  // Register system settings
  game.settings.register("holdvilag", "macroShorthand", {
  ...
  game.settings.register("holdvilag", "initFormula", {
  ...
  const initFormula = game.settings.get("holdvilag", "initFormula");
...
Hooks.on("getActorDirectoryEntryContext", (html, options) => {
  ...
  options.push({
    ...
    condition: li => {
      ...
      return !actor.getFlag("holdvilag", "isTemplate");
    },
    callback: li => {
      const actor = game.actors.get(li.data("entityId"));
      actor.setFlag("holdvilag", "isTemplate", true);
    }
  });
  ...
  options.push({
    ...
    callback: li => {
      const actor = game.actors.get(li.data("entityId"));
      actor.setFlag("holdvilag", "isTemplate", false);
    }
  });
});
...
Hooks.on("getItemDirectoryEntryContext", (html, options) => {
  ...
  options.push({
    ...
    condition: li => {
      ...
      return !item.getFlag("holdvilag", "isTemplate");
    },
    callback: li => {
      const item = game.items.get(li.data("entityId"));
      item.setFlag("holdvilag", "isTemplate", true);
    }
  });
  ...
  options.push({
    ...
    callback: li => {
      const item = game.items.get(li.data("entityId"));
      item.setFlag("holdvilag", "isTemplate", false);
    }
  });
});
...
async function _simpleDirectoryTemplates(collection, event) {
  ...
  let templates = entityCollection.filter(a => a.getFlag("holdvilag", "isTemplate"));
  ...
  const dlg = await renderTemplate(`systems/holdvilag/templates/sidebar/entity-create.html`, templateData);
  return Dialog.confirm({
    ...
    yes: html => {
      ...
      if ( template ) {
        ...
        delete createData.flags.holdvilag.isTemplate;
      }
